package com.uuzz.android.ui.view.pinnedlistview;
...
import com.uuzz.android.ui.view.pinnedlistview.PinnedHeaderListView.PinnedSectionedHeaderAdapter;
...
public abstract class SectionedBaseAdapter extends BaseAdapter implements PinnedSectionedHeaderAdapter {
    ...
    public final View getView(int position, View convertView, ViewGroup parent) {
        ...
        return getItemView(getSectionForPosition(position), getPositionInSectionForPosition(position), position,convertView, parent);
    }
    ...
    public abstract View getItemView(int section, int position, int allPosition,View convertView, ViewGroup parent);
